...
try {
  ...
  // Fetch the current loaded content (evaluated at startup)
  const currentContent = globalThis.EliteProContent;
  
  // Compare the loaded content with the latest content
  if (latestContent !== currentContent) {
    reply(`Update found! Changes detected.\nRestarting in 10 seconds...`);
    
    // Update the loaded content and execute the new version
